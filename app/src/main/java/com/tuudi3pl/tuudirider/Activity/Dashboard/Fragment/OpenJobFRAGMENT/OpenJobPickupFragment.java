 ...
 */
public class OpenJobPickupFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_open_job_pickup, container, false);
    ...
    private void getJob(){
        ...
        JsonObjectRequest jsonReq = new JsonObjectRequest(
                Request.Method.GET,
                URL.URL_LISTING_OPENPICKUP_JOB,
                null,
