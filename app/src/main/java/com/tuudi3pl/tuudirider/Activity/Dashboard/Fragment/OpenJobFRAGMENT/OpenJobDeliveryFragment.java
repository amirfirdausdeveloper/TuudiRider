package com.tuudi3pl.tuudirider.Activity.Dashboard.Fragment.OpenJobFRAGMENT;
 ...
 */
public class OpenJobDeliveryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_open_job_delivery, container, false);
    ...
    private void getJob(){
        ...
        JsonObjectRequest jsonReq = new JsonObjectRequest(
                Request.Method.GET,
                URL.URL_LISTING_OPENDELIVERY_JOB,
                null,
