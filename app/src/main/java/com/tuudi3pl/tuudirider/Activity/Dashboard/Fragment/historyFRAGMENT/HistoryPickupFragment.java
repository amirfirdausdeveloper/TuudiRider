 ...
 */
public class HistoryPickupFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_history_pickup, container, false);
    ...
    private void getJob(){
        ...
        JsonObjectRequest jsonReq = new JsonObjectRequest(
                Request.Method.GET,
                URL.URL_COMPLETED_PICKUP_JOB+userid,
                null,
